    ...
    return (
        <motion.div style={{ height, scrollbarWidth: 'none' }} className="mx-2 flex max-w-full items-center z-50">
            <motion.div
                ...
                className={`${className} absolute bottom-4 left-1/2 transform -translate-x-1/2 flex items-end w-fit gap-4 rounded-2xl border-neutral-700 border-2 bg-[#0f172a]/80 backdrop-blur-md pb-2 px-4 shadow-2xl`}
